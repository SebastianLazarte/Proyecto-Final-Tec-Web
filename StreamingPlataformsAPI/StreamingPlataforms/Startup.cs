...
namespace StreamingPlataforms
{
    public class Startup
    {
        ...
        {
            services.AddTransient<IPlataformService, PlataformService>();
            services.AddTransient<ISerieService, SerieService>();
            services.AddTransient<IPlataformRepository, PlataformRepository>();

            services.Configure<AppSettings>(Configuration.GetSection("AppSettings"));
            services.AddDbContext<PlataformDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("ConnectionString")));
            services.AddControllers();
            services.AddDefaultIdentity<AppUser>()
                .AddEntityFrameworkStores<PlataformDbContext>();
